...
def show(path, label):
    ...
    try:
        ...
        print(f'\033[36m{label:<10}\033[0m \033[2mlast inference\033[0m  model:\033[1m{model}\033[0m  \033[1m{tps:.1f} tok/s\033[0m  tok:\033[1m{tokens}\033[0m  \033[2m@ {ts}\033[0m')
    except: pass
