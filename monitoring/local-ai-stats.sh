...
# usage: ./local-ai-stats.sh | live: watch -n 2 ./local-ai-stats.sh
#
...
# app split — this half covers everything except Claude/Gemini usage, which
# moved to cloud-ai-stats.sh.
#
